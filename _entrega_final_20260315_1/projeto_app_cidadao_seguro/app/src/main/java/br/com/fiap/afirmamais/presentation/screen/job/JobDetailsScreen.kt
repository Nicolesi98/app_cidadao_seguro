    ...
    when {
        ...
        uiState.job == null -> {
            Column(
                ...
                Text("Vaga não encontrada", color = Color(0xFF475569))
                Button(
                    onClick = onBack,
                ...
                item {
                    Column(
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                            ...
                            InfoCard(
                                title = "Vagas",
                                value = "${job.numberOfPositions} ${if (job.numberOfPositions > 1) "posições" else "posição"}",
                    ...
                    Column(
                        ...
                        Button(
                            ...
                            if (uiState.isApplied) {
                                ...
                                Text(
                                    text = if (uiState.justApplied) "Candidatura enviada!" else "Você já se candidatou",
